...
function renderPromise(InnerComponent, name, options) {
    var render = new render_special_1.default(name, options);
    return function (props) {
        return new Promise(function (resolve, reject) {
            ...
            var el = (react_1.default.createElement(InnerComponent, __assign({}, _props, { onOk: function (res) {
                    render === null || render === void 0 ? void 0 : render.unmountComponentAtNode();
                    render = null;
                    resolve(res);
